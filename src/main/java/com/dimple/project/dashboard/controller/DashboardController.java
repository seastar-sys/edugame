...
public class DashboardController extends BaseController {
    ...
    public String main(Model model) {
        ...
        model.addAttribute("nosign", 0);
        //本月访客人数
        model.addAttribute("todayCount", 0);
        return "main";
    }

    @GetMapping("/dashboard/pieData")
    @ResponseBody
    public AjaxResult pieData() {
        Map<String, Object> pieData = dashboardService.getPieData();
        return AjaxResult.success().put("data", pieData);
    }
